...
TruckTel is working just fine on both ETS2 and ATS, on both Windows and native
Linux. Native MacOS is not currently supported, because I don't have a device
to test it on. It should be easy to port though -- pull requests are welcome!
