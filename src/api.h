...
// User data
//==============================================================================
// You can also send data to TruckTel via websockets, which it then stores and
// makes available via the "user" key in the dataset.

/// Configuration key for user data.
static constexpr auto API_CONFIG_USER = "user";
